...
class UnitTest extends TestCase
{
    ...
    public function testEvent(){
        ...
        $this->assertEquals('test',$event->event_description);
        ...
        $this->assertEquals('test',$event->requirements_year);
        $this->assertEquals('test',$event->requirement_one);
        $this->assertEquals('test',$event->requirement_two);
        $this->assertEquals('test',$event->requirement_three);
